...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002e2:	ff 24 85 60 10 80 00 	jmp    *0x801060(,%eax,4)
  ...
  8003ce:	8b 14 85 c0 11 80 00 	mov    0x8011c0(,%eax,4),%edx
  8003d5:	85 d2                	test   %edx,%edx
  8003d7:	75 19                	jne    8003f2 <vprintfmt+0x182>
				printfmt(putch, putdat, "error %d", err);
  8003d9:	50                   	push   %eax
  8003da:	68 a9 0f 80 00       	push   $0x800fa9
  ...
  8003f2:	52                   	push   %edx
  8003f3:	68 b2 0f 80 00       	push   $0x800fb2
  ...
  800418:	b8 a2 0f 80 00       	mov    $0x800fa2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a81:	68 e8 11 80 00       	push   $0x8011e8
  800a86:	6a 23                	push   $0x23
  800a88:	68 05 12 80 00       	push   $0x801205
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b02:	68 e8 11 80 00       	push   $0x8011e8
  800b07:	6a 23                	push   $0x23
  800b09:	68 05 12 80 00       	push   $0x801205
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b44:	68 e8 11 80 00       	push   $0x8011e8
  800b49:	6a 23                	push   $0x23
  800b4b:	68 05 12 80 00       	push   $0x801205
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b86:	68 e8 11 80 00       	push   $0x8011e8
  800b8b:	6a 23                	push   $0x23
  800b8d:	68 05 12 80 00       	push   $0x801205
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bc8:	68 e8 11 80 00       	push   $0x8011e8
  800bcd:	6a 23                	push   $0x23
  800bcf:	68 05 12 80 00       	push   $0x801205
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c0a:	68 e8 11 80 00       	push   $0x8011e8
  800c0f:	6a 23                	push   $0x23
  800c11:	68 05 12 80 00       	push   $0x801205
...
sys_ipc_recv(void *dstva)
{
  ...
  800c6e:	68 e8 11 80 00       	push   $0x8011e8
  800c73:	6a 23                	push   $0x23
  800c75:	68 05 12 80 00       	push   $0x801205
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ca3:	56                   	push   %esi
  800ca4:	50                   	push   %eax
  800ca5:	68 14 12 80 00       	push   $0x801214
  ...
  800cb6:	e8 2d f4 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800cbb:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
